  ...
  return (
    <nav className="sticky top-0 z-40 bg-black/[85%] col-span-full text-sm">
      <div className="relative grid grid-cols-4 lg:grid-cols-5 gap-y-3 gap-x-6 p-6">
        ...
        <div className="col-span-2 lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-3 gap-x-6 self-start">
          <div className="col-span-1 lg:col-span-2 grid grid-cols-1 lg:grid-cols-2 gap-y-3 gap-x-6">
            <NavLink
              href="/news"
              name="News"
